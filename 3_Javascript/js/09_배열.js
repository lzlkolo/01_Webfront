...
function check4() {
    ...
    const arr = new Array(5); // 5칸 짜리 배열 (내용 없음)
...
function selectMenu() {
    ...
    // 난수(randomNumber)번째 index 요소값을 화면에 출력
