...
function plusFn() {
    ...
    console.log(value1, value2); //value1: 10, value2: 20
    console.log("두 수의 합 : ", value1+value2); //출력: 1020
    ...
    console.log("두 수의 합 : ", Number(value1) + Number(value2)); //출력: 30
...
function check() {
    // 함수 밖, 안은 구분되는 공간임 
    // 밖에 선언한 변수 count, 안에 작성한 count는 서로 다른 변수(동명이인)
    let count = 100;
    ...
    // -> 다른 연산보다 먼저 수행
    // count 값이 먼저 증가, 감소된 후에 consle에 출력
